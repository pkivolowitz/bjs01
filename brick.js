...
class Brick {
	...
	constructor(scene) {
		...
		if (Brick.wood == null) {
			Brick.wood = new BABYLON.StandardMaterial("grass0", scene);
			Brick.wood.diffuseTexture = new BABYLON.Texture("./w.jpeg", scene);
		...
		this.brick.physicsImposter = new BABYLON.PhysicsImpostor(this.brick, BABYLON.PhysicsImpostor.BoxImpostor, 
			{ disableBidirectionalTransformation: false, mass: 4, restitution: 0.0 }, scene);
